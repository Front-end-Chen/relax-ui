...
describe('test Input component', () => {
  it('should render the correct default Input', () => {
    ...
    expect(testNode).toHaveClass('relax-input-inner')
  ...
  it('should render different input sizes on size property', () => {
    const wrapper = render(<Input placeholder="sizes" inputSize="lg" />)
    const testContainer = wrapper.container.querySelector('.relax-input-wrapper')
  ...
  it('should render prepand and append element on prepand/append property', () => {
    ...
    const testContainer = container.querySelector('.relax-input-wrapper')
