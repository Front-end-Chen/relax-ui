...
describe('test Menu and MenuItem component in default(horizontal) mode', () => {
  ...
  it('should render correct Menu and MenuItem based on default props', () => {
    ...
    expect(menuElement).toHaveClass('relax-menu test')
    expect(menuElement.querySelectorAll(':scope > li').length).toEqual(5)
    expect(activeElement).toHaveClass('relax-menu-item active')
    expect(disabledElement).toHaveClass('relax-menu-item disabled')
  })
...
describe('test Menu and MenuItem component in vertical mode', () => {
  ...
  it('should render vertical mode when mode is set to vertical', () => {
    ...
    expect(menuElement).toHaveClass('relax-menu-vertical')
  })
